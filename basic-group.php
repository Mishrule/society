                                                    ...
                                                    <form action="/upload" class="dropzone dropzone-custom needsclick add-professors" id="demo1-upload">
                                                        <div class="row">
                                                            ...
                                                            <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
                                                                <div class="white-box">
                                                                    <h5 class="box-title">Click to Perform Activity</h5>
                                                                            ...
                                                                            while ($groupFetchRow = mysqli_fetch_array($groupFetchResult)) {
                                                                                ...
                                                                                <div class="form-check">
                                                                                    <label class="form-check-label " style="font-size:13px;">
                                                                                        <input class="form-check-input activityGroupEdit" type="checkbox" id="' . $groupFetchRow['group_id'] . '" name="' . $groupFetchRow['group_id'] . '"  value="">
                                                                                        ' . $groupFetchRow['group_name'] . '<span class="form-check-sign">
